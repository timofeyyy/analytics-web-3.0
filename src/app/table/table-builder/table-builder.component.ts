...
export class TableBuilderComponent implements OnInit {
  ...
  loader!: boolean
  popupHint!: boolean
  selectionWindow!: boolean
  prioritySchemaWrapperMap!: any
  ...
  ngOnInit(): void {
    ...
    componentTypes.forEach(val => {
      ...
      componentTypesObj[ruComponentType] = enComponentType
    })
    this.prioritySchemaWrapperMap = new Map(Object.entries(componentTypesObj))
  }

  initDropBoxMapConfig(): Map<string, any> {
  ...
  onAutoGeneratedSchemaSelected(): void {
    ...
    if (this.autoGeneratedSchema) {
      const table = this.prioritySchemaWrapperMap.get(this.stepper.get('step1')!.obj)
  ...
  prev(): void {
    if (this.step < 0) {
      ...
      this.stepper.get('step2')!.obj = undefined
      this.stepper.get('step1')!.obj = undefined
      this.dropBoxPropsMapConfig = this.initDropBoxMapConfig()
    }
  }
